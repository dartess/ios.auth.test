...
let rootUrl = URL(string: "https://dartess.github.io/ios.auth.test/")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["dartess.github.io"]
...
// subdomains that are allowed, but must be forced to open in the popup
let allowedOriginsForcedPopupMode: [String] = [""];
